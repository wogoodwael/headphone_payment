...
import 'package:headphone_payment/thank_you.dart';
...
// Let's initialize it to -1 to indicate no selection initially
  ...
  Widget build(BuildContext context) {
    List img = ["assets/images/credit_card.svg", "assets/images/paypal.svg"];
    return Scaffold(
                  ...
                  ? Column(
                      children: [
                        ...
                        CreditCardForm(
                            ...
                            formKey: formKey), 
                            SizedBox(height: .07*MediaQuery.sizeOf(context).height,), 
                            ElevatedButton(
                              ...
                              onPressed: (){
                                if (formKey.currentState!.validate()) {
                                  ...
                                  Navigator.push(context, MaterialPageRoute(builder: (_)=>ThankYouView()));
                                } else {
